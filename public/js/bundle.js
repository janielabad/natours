...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoianZjYWJhZCIsImEiOiJja2NkdmdiY2kwMmQ5MndvemV5N3U4MzA5In0.x5wkLzVlk_b0rAOzEc-9Sg';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // go to homepage after logging in
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true); // force reload from server not browser cache
            }
...
var passwordForm = document.querySelector('.form-user-password'); // DELEGATION
